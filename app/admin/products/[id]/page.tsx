      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-5 text-[#5f5a52] text-lg">
            Update product details, code, brand, category and pricing.
          </p>
        </div>
        ...
        <div className="bg-white rounded-[2rem] shadow-2xl border border-[#C8A96B]/20 overflow-hidden">
          <div className="bg-[#F1E7D8] px-10 py-8 border-b border-[#C8A96B]/20">
            ...
            <p className="mt-3 text-[#5f5a52]">
              The Libas Studio product management panel.
            </p>
          </div>
          ...
          <div className="p-10 space-y-6">
            ...
            <input
              type="text"
              placeholder="Product Code e.g TLS-3P-001"
              value={productCode}
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button
                ...
                disabled={saving}
                className="flex-1 bg-[#1E1E1E] text-white py-5 rounded-full hover:bg-[#C8A96B] hover:text-[#1E1E1E] transition duration-300 text-lg font-semibold shadow-xl"
              >
              ...
              <Link
                href="/admin/products"
                className="flex-1 text-center bg-[#F1E7D8] text-[#1E1E1E] py-5 rounded-full hover:bg-[#C8A96B] transition duration-300 text-lg font-semibold"
              >
                Back
              </Link>
            </div>
